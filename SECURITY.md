...
1. Go to the [Security tab](https://github.com/victoriaEssien/delta/security/advisories/new)
...
For security-related questions, use [GitHub Security Advisories](https://github.com/victoriaEssien/delta/security/advisories).
